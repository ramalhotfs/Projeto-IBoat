...
<html lang="en">
    ...
    <body>
        <div class="container-fluid mb-5">
            <div class="mt-3">
                <a href='../Login/logout.php?codigo=2' class='btn btn-danger sair'>Sair</a>
            </div>
                <div class="row">
                    <div class="col-5">
                            ...
                            <table id="table_id" class="table table-striped" >
                                ...
                                <tbody>
                                        <?php
                                            if(!isset($_SESSION))
                                                session_start();
                                            $consul = "SELECT * FROM barco WHERE cpf = '$_SESSION[cpf]'";
    ...
    $(document).ready(function() {
            ...
            ( {
                "language": 
                {
                            "sEmptyTable":   	"Não há barcos cadastrados",
